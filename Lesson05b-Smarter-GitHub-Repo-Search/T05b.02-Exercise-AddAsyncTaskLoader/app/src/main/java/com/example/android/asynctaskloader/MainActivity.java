...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 25;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText("Nothing has been entered");
            return;
        }
        ...
        queryBundle.putString(SEARCH_QUERY_URL_EXTRA, mUrlDisplayTextView.getText().toString());
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String url = bundle.getString(SEARCH_QUERY_URL_EXTRA);
